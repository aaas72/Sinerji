...
export default function ActiveTaskCard({
  ...
  return (
    <Link href={`/company/tasks/${id}/details`} className="block group">
      <div className="p-6 transition-all duration-300 ease-out cursor-pointer hover:z-10 hover:bg-white hover:bg-gradient-to-br hover:from-[#004d40]/[0.06] hover:to-[#ffd54f]/10 hover:scale-[1.02] bg-transparent relative border border-transparent hover:border-[#004d40]/50 hover:rounded-none hover:shadow-md">
