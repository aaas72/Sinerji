  ...
  return (
    <div
      className={cn(
        ...
        borderless
          ? "bg-transparent border border-transparent hover:bg-white hover:bg-gradient-to-br hover:from-[#004d40]/[0.045] hover:to-[#ffd54f]/[0.075] hover:scale-[1.05] hover:border-[#004d40]/50 hover:rounded-none hover:shadow-md"
          : cn(
