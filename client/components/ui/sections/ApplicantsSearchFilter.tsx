...
export default function ApplicantsSearchFilter({
  ...
  return (
    <div className="bg-transparent border border-[#dfded6] rounded-[50px] p-4 mb-8 flex flex-col lg:flex-row items-center gap-4 select-none">
      {/* Search Input Box */}
      ...
      <div className="flex flex-wrap items-center gap-3 w-full lg:w-auto">
        ...
        <div className="relative w-full sm:w-auto">
          <input
            ...
            className="w-full bg-white/50 border-[#bfc9c4]/50 border rounded-full px-5 py-2.5 focus:ring-2 focus:ring-[#00342b]/20 focus:border-[#00342b] outline-none text-xs font-bold text-[#3f465c] transition-all placeholder-gray-450"
          />
        </div>
