...
function SectionCard({
  ...
  return (
    <div className="rounded-2xl border border-[#dfded6] bg-transparent overflow-hidden transition-all duration-300 hover:scale-[1.01] hover:bg-white hover:bg-gradient-to-br hover:from-[#004d40]/10 hover:to-[#ffd54f]/15 hover:border-[#004d40]/50 hover:shadow-md hover:rounded-none group/card">
...
function StatBadge({ value, label }: { value: string | number; label: string }) {
  return (
    <div className="flex flex-col items-center justify-center rounded-2xl border border-[#dfded6] bg-transparent px-6 py-4 min-w-[120px] transition-all duration-300 hover:scale-[1.05] hover:bg-white hover:bg-gradient-to-br hover:from-[#004d40]/10 hover:to-[#ffd54f]/15 hover:border-[#004d40]/50 hover:shadow-md hover:rounded-none cursor-pointer">
