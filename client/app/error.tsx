    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 text-center space-y-6 border border-gray-100">
        ...
        <div className="space-y-2">
          <h2 className="text-2xl font-bold text-gray-900">Bir Şeyler Ters Gitti</h2>
          <p className="text-gray-500 text-sm">
            Sayfa yüklenirken bir sorun oluştu. Bağlantınızı kontrol edip tekrar deneyebilirsiniz.
          </p>
        </div>
